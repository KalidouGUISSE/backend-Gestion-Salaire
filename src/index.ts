...
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175/','https://frontend-gestion-salaire.vercel.app'], // <-- URLs de ton frontend React (incluant le port alternatif)
